...
_define('taobao.utils.uriBroker.getUrl',function(require){
    var uri = require ? require('./uri.js') : namespace('taobao.utils.uri');
    ...
    uriBroker.URL_CONSTANTS = URL_CONSTANTS = {
        //可以继续定义一些通用的规则...
        path: {
            home: 'index.htm',
    ...
    uriBroker.getDps = _getDps = function(module, param) {
        if (param['dps']) {
            return param['dps'];
        }
